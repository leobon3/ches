    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="admin_building.php">Buildings <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
      ...
      <ul class="navbar-nav">
        <li class="nav-item" style="margin-left: 10px;">
          ...
          if (isset($_SESSION['username'])) {
              ...
              echo '<button class="btn btn-primary" data-toggle="modal" data-target="#loginModal">Login</button>';
          }
          ?>
        </li>
      </ul>
...
<form class="form-inline mb-3" method="GET" action="">
 ...
 <table class="table">
    ...
    <?php foreach ($filteredCompanies as $company): ?>
        <tr>
            <td><strong><a href="company.php?name=<?php echo urlencode($company['companyName']); ?>" style="color: black;"><?php echo htmlspecialchars($company['companyName']); ?></a></strong></td>
            <td><strong><?php echo htmlspecialchars($company['buildingCount']); ?></strong></td>
            <td class="action text-center"> <!-- Added 'text-center' class -->
                <!-- Edit button -->
                <a href="edit_company.php?name=<?php echo urlencode($company['companyName']); ?>" class="btn btn-sm btn-primary mr-2 rounded-pill">Edit</a> <!-- Added 'mr-2' class for right margin -->
                <a href="delete_company.php?name=<?php echo urlencode($company['companyName']); ?>" class="btn btn-sm btn-danger rounded-pill">Delete</a>
            </td>
        </tr>
    <?php endforeach; ?>
<?php else: ?>
